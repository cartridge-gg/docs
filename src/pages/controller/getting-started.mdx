...
The ControllerConnector supports the [get-starknet wallet standard](https://get-starknet.vercel.app/), a higher-level interface than `StarknetWindowObject` which enables integration with libraries like `starknet-react` and `solid.js`.
