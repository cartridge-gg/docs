...
-   Multi-signer support with Passkeys, password authentication (testing only), social login (Google, Discord), and external wallets (Braavos, MetaMask, Rabby, WalletConnect)
